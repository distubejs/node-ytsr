...
exports.logger = content => {
  ...
  const file = PATH.resolve(dir, `${Math.random().toString(36).slice(3)}-${Date.now()}.txt`);
  ...
  console.error(`Please post the the files in ${dir} to ${bugsRef} or DisTube support server. Thanks!`);
