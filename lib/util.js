...
exports.buildPostBody = (searchString, options = {}) => {
  if (!searchString && !options.continuation) throw new Error('search string or continuation is mandatory');
...
const fetchAPIKey = exports.fetchAPIKey = async (retried = 0) => {
  if (API_KEY.key) {
    return API_KEY;
  } else if (retried === 0 && API_KEY.key === null) {
